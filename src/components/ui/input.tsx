  ...
  return (
    <input
      ...
      className={cn(
        ...
        "flex h-11 w-full rounded-[10px] border border-border bg-nummiq-surface2 px-3 text-base sm:text-sm text-nummiq-white transition-colors duration-150 hover:border-nummiq-silver/30 placeholder:text-nummiq-muted file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-nummiq-silver focus-visible:outline-none focus-visible:border-nummiq-silver focus-visible:ring-2 focus-visible:ring-ring/30 disabled:cursor-not-allowed disabled:opacity-50",
        className
      )}
      ref={ref}
      {...props}
